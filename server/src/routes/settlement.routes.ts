...
import { getGroupBalances, getSimplifiedSettlements, recordSettlement, getMyTotals, getMySettlements } from '../controllers/settlement.controller';
...
router.get('/me', getMySettlements);
