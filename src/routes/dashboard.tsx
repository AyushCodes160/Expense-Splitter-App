    ...
    <AppShell>
      <div className="animate-fade-in-up">
        ...
        <div className="mt-8 grid gap-6 sm:grid-cols-1 md:grid-cols-3">
          <div className="md:col-span-2 glass-strong rounded-[2rem] p-8 flex flex-col justify-between transition-all hover:shadow-glow relative overflow-hidden group">
            ...
            <p className="mt-8 text-6xl font-bold tracking-tighter relative z-10">
